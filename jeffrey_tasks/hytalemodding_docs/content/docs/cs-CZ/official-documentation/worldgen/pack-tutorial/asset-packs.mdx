...
<video controls className="my-6 aspect-video w-full rounded-lg border">
  <source src="https://cdn.internal.hytalemodding.dev/guides/official/how-to-asset-pack.mp4" type="video/mp4" />
</video>
...
<video controls className="my-6 aspect-video w-full rounded-lg border">
  <source src="https://cdn.internal.hytalemodding.dev/guides/official/how-to-install.mp4" type="video/mp4" />
</video>
...
<video controls className="my-6 aspect-video w-full rounded-lg border">
  <source src="https://cdn.internal.hytalemodding.dev/guides/official/how-to-asset.mp4" type="video/mp4" />
</video>
