...
1. `/editprefab new <world name>` to create a new prefab editing world: `/editprefab new my_prefab_world`
   - Note que `my_prefab` é o nome do _mundo_, não do prefab em si. Worlds can contain multiple prefabs.
...
- `exit`
  - Encerra a edição do mundo do prefab atual.
- `load`
  - Cria um novo mundo de edição de prefab para colar um prefab existente.
- `new`
